...
const Card = (props) => {
    ...
    return (
        <div>
            <div class="card border" style={{padding:"10px", width : "50vh",minHeight:"250px"}}>
                <div class="card-body d-flex flex-column" style={{marginTop : "30px"}}>
                    <span className='cardInnerBox'>
                        ...
                        {
                            (!props.isJoin) && <button type="button" onClick={()=>{addToMyCommunity(props.room,user);props.callFunc();}} className="cardJoinButton1">JOIN</button>
                        }
                    </span>
                </div>
            </div>
